...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_PIN           PI11 // Pin to detect power-loss. Set to -1 to disable default pin on boards without module, or comment to use board default.
 ...
 */
  ...
  #define MMU_SERIAL_PORT 6 //Serial wifi
  #define MMU_BAUD 115200

  //#define MMU_RST_PIN PF11    // Define this pin to use Hardware Reset for MMU2/MMU2S/MMU3
