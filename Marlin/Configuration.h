...
#define STRING_CONFIG_H_AUTHOR "(Johnny Eshak, JTO CoreXY)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Eshak CoreXY"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP  16.54
  #define DEFAULT_BED_KI   0.97
  #define DEFAULT_BED_KD 187.92
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 2400, 415 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 1000, 1000, 25, 50 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -31, 1, 0 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 3), (Y_MIN_POS + 500), 10 }
